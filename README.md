...
| Image | Status |
| ------------- | ------------- |
| Shopping Client | [![Build Status](https://dev.azure.com/mayankazure1988/AzureCICDDemo/_apis/build/status%2Fshopping.client.pipeline?branchName=main)]([[https://dev.azure.com/mayankazure1988/AzureCICDDemo/_build/latest?definitionId=10&branchName=main](https://dev.azure.com/mayankazure1988/AzureCICDDemo/_apis/build/status%2Fshopping.client.pipeline?branchName=main)](https://dev.azure.com/mayankazure1988/AzureCICDDemo/_apis/build/status%2Fshopping.client.pipeline?branchName=main))|
